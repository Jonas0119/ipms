...
IpmsPage({
    ...
    save() {
        this.validate(() => {
            ...
            // 当未办理登记证时，清空与登记/疫苗相关字段，避免后端校验歧义
            const payload = {
                pet_type,
                name,
                sex,
                ...
                breed,
                haveLicense,
                pet_license: haveLicense ? pet_license : '',
                pet_license_award_at: haveLicense ? pet_license_award_at : '',
                vaccinated_at: haveLicense ? vaccinated_at : '',
                vaccine_type: haveLicense ? vaccine_type : '',
