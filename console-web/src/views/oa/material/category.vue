...
export default {
    ...
    methods: {
        getListData() {
            ...
            utils.request
                .post('/material/category_list', { page_num, page_size })
                .then(res => {
                    this.fetching = false;
        ...
        delete(id, index) {
            Modal.confirm({
                ...
                onOk: () => {
                    utils.request
                        .get(`/material/category_delete/${id}`)
                        .then(() => {
        ...
        submit() {
            this.$refs.form.validate(valid => {
                ...
                if (this.editId) {
                    utils.request
                        .post('/material/category_update', { ...this.form, id: this.editId })
                        .then(() => {
                    ...
                    utils.request
                        .post('/material/category_create', this.form)
                        .then(res => {
                            this.list.unshift({
                                id: res.data.id,
                                ...this.form,
