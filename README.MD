...
### 容器 IP 地址分配
- **MySQL (mysql57)**: `172.17.0.2:3306`
- **Redis (my-redis)**: `172.17.0.3:6379`
- **MinIO (minio)**: `172.17.0.4:9000/9001`
- **API Server (api-server1)**: `172.17.0.5:6688`
- **Nginx (my-nginx1)**: `172.17.0.6:80`
