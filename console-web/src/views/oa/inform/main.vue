...
import { Header, ListFooter, FilterQuery, WaterMark, Images } from '@/components';
        ...
        return {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: (h, p) => {
                        if (p.row.carousel) {
                            return h(Images, { props: { imgs: [p.row.cover_img] } });
                        }
                ...
                },
                {
                    title: '发布时间',
                    minWidth: 180,
                    render: (h, p) => h('span', moment(p.row.published_at).format('YYYY-MM-DD HH:mm:ss'))
                },
                {
                    title: '操作',
                    key: 'id',
