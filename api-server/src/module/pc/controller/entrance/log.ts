...
const PcEntranceLogAction = <Action>{
    ...
    response: async ctx => {
        ...
        const list = await ctx.model
            ...
            .select(ctx.model.raw('SQL_CALC_FOUND_ROWS ipms_iot_entrance_log.id'))
            .select(
                'ipms_iot_entrance_log.id',
                'ipms_iot_entrance_log.method',
                'ipms_iot_entrance_log.created_at',
                'ipms_iot_entrance_log.wechat_mp_user_id as owner_id',
                'ipms_wechat_mp_user.real_name as owner_real_name',
                'ipms_iot_entrance_log.vistor_id',
